...
- (void) setContentWithObject:(id) object AtIndexPath: (NSIndexPath *) indexPath
{
    ...
    PublishObject *tmpObj = [(NSMutableArray *)object objectAtIndex:indexPath.row];
    
    [headerImageView setImageWithURL:[NSURL URLWithString:tmpObj.p_imgUrl] placeholderImage:[UIImage imageNamed:@"cell_place"]];
    title.text = tmpObj.p_title;
}
