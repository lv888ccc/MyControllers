...
#import "XinHuaBookViewController.h"
...
@interface XinHuaBookViewController ()<MyTableViewDelegate>
{
    NSInteger pageIndex;
}
...
@implementation XinHuaBookViewController
...
- (void)viewDidLoad
{
    ...
    self.myTable.cellNameString = @"XinHuaBookCell";
...
{
    pageIndex = 1;
    [self.myRequest xinHuaBookNewsWithPageNo:pageIndex];
}
...
{
    BookObject *tmpObject = [self.tableData objectAtIndex:indexPath.row];
...
#pragma mark -
#pragma mark - 网络数据返回
- (void) xinHuaBookNewsCallBack:(id) objectData
{
