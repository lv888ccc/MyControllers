...
@interface BookHomeViewController ()<TitleNavViewDelegate,VCScrollViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    NSMutableArray *tmpArr = [NSMutableArray arrayWithObjects:@"新华书讯",@"畅销榜",@"精彩书评", nil];
    ...
    [vcScrollView setVcArrWithViewControllerString:@"XinHuaBookViewController" keyString:@"0"];
...
- (void) setViewControllerWithIndex:(NSInteger) index
{
    ...
    {
        case 0://新华书讯
            [vcScrollView setVcArrWithViewControllerString:@"XinHuaBookViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 1://畅销榜
            [vcScrollView setVcArrWithViewControllerString:@"HotSellBookViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 2://精彩书评
            [vcScrollView setVcArrWithViewControllerString:@"BookCommentViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
