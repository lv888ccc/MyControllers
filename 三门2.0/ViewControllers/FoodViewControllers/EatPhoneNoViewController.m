...
#import "EatPhoneNoViewController.h"
...
@interface EatPhoneNoViewController ()<MyTableViewDelegate>
{
    NSInteger pageIndex;
}
...
@implementation EatPhoneNoViewController
...
- (void)viewDidLoad
{
    ...
    self.myTable.cellNameString = @"EatPhoneNoCell";
...
{
    pageIndex = 1;
    [self.myRequest foodPhoneWithPageNo:pageIndex];
}
...
//美食-外卖电话
- (void) foodPhoneCallBack:(id) objectData
{
