...
@interface FoodViewController ()<TitleNavViewDelegate,VCScrollViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    NSMutableArray *tmpArr = [NSMutableArray arrayWithObjects:@"餐饮美食",@"外卖电话",@"酒店住宿", nil];
    ...
    [vcScrollView setVcArrWithViewControllerString:@"EatViewController" keyString:@"0"];
...
- (void) setViewControllerWithIndex:(NSInteger) index
{
    ...
    {
        case 0://餐饮美食
            [vcScrollView setVcArrWithViewControllerString:@"EatViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 1://外卖电话
            [vcScrollView setVcArrWithViewControllerString:@"EatPhoneNoViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 2://宾馆住宿
            [vcScrollView setVcArrWithViewControllerString:@"HotelViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
