...
@interface EatViewController ()<MyTableViewDelegate>
{
    NSInteger pageIndex;
}
...
- (void)viewDidLoad
{
    ...
    self.myTable.cellNameString = @"EatCell";
...
{
    pageIndex = 1;
    [self.myRequest foodEatWithPageNo:pageIndex];
}
...
//美食-餐饮
- (void) foodEatCallBack:(id) objectData
{
