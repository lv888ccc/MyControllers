...
@interface LocalNewsViewController ()<TitleNavViewDelegate,VCScrollViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    NSMutableArray *tmpArr = [NSMutableArray arrayWithObjects:@"三门概况",@"旅游景点",@"特色小吃",@"视频三门", nil];
...
- (void) setViewControllerWithIndex:(NSInteger) index
{
    ...
    {
        case 0://三门概况
            [vcScrollView setVcArrWithViewControllerString:@"AboutSanMenViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 1://旅游景点
            [vcScrollView setVcArrWithViewControllerString:@"InterestringPlaceViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 2://特色小吃
            [vcScrollView setVcArrWithViewControllerString:@"CharactorFoodViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 3://视频三门
            [vcScrollView setVcArrWithViewControllerString:@"VideoSanMenViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
