//
//  InterestringPlaceViewController.m
//  SanMen
//
...
#import "InterestringPlaceViewController.h"
...
@interface InterestringPlaceViewController ()<MyTableViewDelegate>
{
    NSInteger pageIndex;
}
...
@implementation InterestringPlaceViewController
...
- (void)viewDidLoad
{
    ...
    self.myTable.cellNameString = @"InterestringPlaceCell";
...
{
    pageIndex = 1;
    [self.myRequest localNewsInterestingPlaceWithPageNo:pageIndex];
}
...
#pragma mark - 网络数据放回
//三门-新闻
- (void) localNewsInterestingPlaceCallBack:(id) objectData
{
