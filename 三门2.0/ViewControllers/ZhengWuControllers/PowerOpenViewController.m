...
#import "PowerOpenViewController.h"
...
@interface PowerOpenViewController ()<MyTableViewDelegate>
{
    NSInteger pageIndex;
}
...
@implementation PowerOpenViewController
...
- (void)viewDidLoad
{
    ...
    self.myTable.cellNameString = @"PowerOpenCell";
...
{
    pageIndex = 1;
    [self.myRequest zhengWuPowerOpenWithPageNo:pageIndex];
}
...
#pragma mark - 网络数据放回
//政务-权利公开
- (void) zhengWuPowerOpenCallBack:(id) objectData
{
