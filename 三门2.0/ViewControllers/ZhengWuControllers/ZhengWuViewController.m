...
@interface ZhengWuViewController ()<TitleNavViewDelegate,VCScrollViewDelegate>
{
...
- (void)viewDidLoad
{
    ...
    NSMutableArray *tmpArr = [NSMutableArray arrayWithObjects:@"公告公示",@"政府公开", nil];
    ...
    contentSize.width = 320*2;
    vcScrollView.contentSize = contentSize;
    [vcScrollView setV_delegate:self];
    [self.view addSubview:vcScrollView];
    
    [vcScrollView setVcArrWithViewControllerString:@"PublicViewController" keyString:@"0"];
...
- (void) setViewControllerWithIndex:(NSInteger) index
{
    ...
    {
        case 0://公告公示
            [vcScrollView setVcArrWithViewControllerString:@"PublicViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 1://政府公开
            [vcScrollView setVcArrWithViewControllerString:@"GovernmentViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
            
        case 2://权力公开
            [vcScrollView setVcArrWithViewControllerString:@"PowerOpenViewController" keyString:[NSString stringWithFormat:@"%d",index]];
            break;
