...
@interface PublicViewController ()<MyTableViewDelegate>
{
    NSInteger pageIndex;
}
...
- (void)viewDidLoad
{
    ...
    self.myTable.cellNameString = @"PublicCell";
...
{
    pageIndex = 1;
    [self.myRequest zhengWuPublicNoticeWithPageNo:pageIndex];
}
...
#pragma mark - 网络数据放回
//政务-政务公开
- (void) zhengWuPublicNoticeCallBack:(id) objectData
{
