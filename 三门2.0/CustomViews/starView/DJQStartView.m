...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        self.radius = x < y ? x:y;
        self.value = 1;
        self.startColor = [UIColor colorWithRed:250.0f/255.0f green:168.0f/255.0f blue:0.0f/255.0f alpha:1.0];;
...
-(id) initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        self.startColor = [UIColor colorWithRed:250.0f/255.0f green:168.0f/255.0f blue:0.0f/255.0f alpha:1.0];;
        self.backgroundColor = [UIColor clearColor];
        self.boundsColor = [UIColor colorWithRed:250.0f/255.0f green:168.0f/255.0f blue:0.0f/255.0f alpha:1.0];
...
- (void)drawRect:(CGRect)rect
{
    ...
    range = CGRectMake(x1[1], 0, (x1[4] - x1[1]) * self.value , y1[2]);
    CGContextAddPath(context, startPath);
    CGContextClip(context);
    CGContextFillRect(context, range);
